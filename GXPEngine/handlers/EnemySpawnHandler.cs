...
public class EnemySpawnHandler : GameObject
{
    ...
    void spawn()
    {
        ...
        {
            SmallEnemy smallEnemy = new SmallEnemy("assets/debug/small_enemy_spider.png", -100, random.Next(game.height - 400) + 200, 25 , 1, 20, true, 8, 1);
        ...
        {
            MediumEnemy shootable = new MediumEnemy("assets/debug/circle.png", -100, random.Next(game.height - 400) + 200, 15, 3);
        ...
        {
            LargeEnemy LargeEnemy = new LargeEnemy("assets/debug/large_monster_slime.png", -100, random.Next(game.height - 400) + 200, 5, 5, 100, true, 7, 1);
